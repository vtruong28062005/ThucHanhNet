...
{
    public class frmThongKeMua : Form
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.lblTieuDe.Text = "THỐNG KÊ CHI TIẾT HÀNG MUA (QLKD)";
            ...
            this.grpBoLoc.Controls.Add(this.lblNCC);
            this.grpBoLoc.Controls.Add(this.cboNCC);
            ...
            this.grpBoLoc.ForeColor = Color.Navy;
            ...
            this.lblNCC.Location = new Point(20, 68);
            ...
            this.cboNCC.Location = new Point(130, 65);
            this.cboNCC.Name = "cboNCC";
            this.cboNCC.Size = new Size(250, 28);
            ...
            // btnThongKe
            this.btnThongKe.BackColor = Color.SteelBlue;
            ...
            this.grpKetQua.Text = "Bảng dữ liệu Thống kê Hàng Mua (Công việc 3a)";
            ...
            // pnlTongHop
            this.pnlTongHop.BackColor = Color.FromArgb(235, 240, 250);
            ...
            this.lblTongSoDong.Text = "Số lượt mua: 0";
            ...
            this.lblTongSoLuong.Text = "Tổng số lượng mua: 0";
            ...
            this.lblTongThanhTien.Text = "Tổng tiền hàng mua: 0 VNĐ";
            ...
            this.Name = "frmThongKeMua";
            this.StartPosition = FormStartPosition.CenterScreen;
            this.Text = "Công việc 3a: Thống kê Hàng Mua";
            this.Load += new EventHandler(this.frmThongKeMua_Load);
        ...
        private void frmThongKeMua_Load(object sender, EventArgs e)
        {
        ...
        private void LoadCombos()
        {
            ...
            {
                // Combo NCC
                DataTable dtNCC = DatabaseHelper.ExecuteDataTable("SELECT Mancc, Tenncc FROM NCC ORDER BY Tenncc");
                DataRow rNCC = dtNCC.NewRow();
                rNCC["Mancc"] = "";
                rNCC["Tenncc"] = "-- Tất cả Nhà cung cấp --";
                dtNCC.Rows.InsertAt(rNCC, 0);
        ...
        private void ThucHienThongKe()
        {
            ...
            {
                string sql = "SELECT " +
                             "ROW_NUMBER() OVER (ORDER BY HD.Ngaymua DESC) AS [STT], " +
                             "H.Tenhang AS [Tên hàng], " +
                             "H.DVT AS [Đơn vị tính], " +
                             "NCC.Tenncc AS [Nhà cung cấp], " +
                             "HD.Ngaymua AS [Ngày mua], " +
                             "CT.Soluongmua AS [Số lượng mua], " +
                             "CT.Dongiamua AS [Đơn giá mua], " +
                ...
                if (chkLocNgay.Checked)
                {
                    ...
                    sql += " AND HD.Ngaymua BETWEEN @tu AND @den ";
                ...
                {
                    sql += " AND HD.Mancc = @mancc ";
                    prms.Add(new SqlParameter("@mancc", cboNCC.SelectedValue.ToString()));
                }
                ...
                if (dgvThongKe.Columns["Ngày mua"] != null)
                {
                    dgvThongKe.Columns["Ngày mua"].DefaultCellStyle.Format = "dd/MM/yyyy HH:mm";
                }
                if (dgvThongKe.Columns["Số lượng mua"] != null)
                {
                    dgvThongKe.Columns["Số lượng mua"].DefaultCellStyle.Format = "#,##0";
                    dgvThongKe.Columns["Số lượng mua"].DefaultCellStyle.Alignment = DataGridViewContentAlignment.MiddleRight;
                }
                if (dgvThongKe.Columns["Đơn giá mua"] != null)
                {
                    dgvThongKe.Columns["Đơn giá mua"].DefaultCellStyle.Format = "#,##0";
                    dgvThongKe.Columns["Đơn giá mua"].DefaultCellStyle.Alignment = DataGridViewContentAlignment.MiddleRight;
                }
                ...
                {
                    if (row["Số lượng mua"] != DBNull.Value)
                    {
                        tongSL += Convert.ToInt32(row["Số lượng mua"]);
                    }
                ...
                lblTongSoDong.Text = string.Format("Số lượt mua: {0}", dt.Rows.Count);
                lblTongSoLuong.Text = string.Format("Tổng số lượng mua: {0:#,##0}", tongSL);
                lblTongThanhTien.Text = string.Format("Tổng tiền hàng mua: {0:#,##0} VNĐ", tongTien);
            }
            catch (Exception ex)
            {
